...
public class SignLanguageDictionary implements ActionListener {
	...
	private void initializeGUI() {
		...
		translateField.setBorder(new BevelBorder(BevelBorder.LOWERED, null,
				null, null, null));
		...
		gl_bottomPanel.setHorizontalGroup(gl_bottomPanel.createParallelGroup(
				...
				gl_bottomPanel
						...
						.addGap(74)
						.addComponent(translateField, GroupLayout.DEFAULT_SIZE,
								259, Short.MAX_VALUE)
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addComponent(submitButton, GroupLayout.PREFERRED_SIZE,
								77, GroupLayout.PREFERRED_SIZE).addGap(64)));
		gl_bottomPanel
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == submitButton) {
			...
			str = parseText(translateField.getText());
			image = getImage(str);
	...
	public static String parseText(String txt) {
		txt = txt.trim(); // trims leading and trailing whitespace.
	...
	public ImageIcon getImage(String str) {
		ImageIcon image;
		try {
			image = new ImageIcon(this.getClass().getResource("/pics/" + str));
		} catch (Exception e) {
			image = new ImageIcon(this.getClass().getResource("/pics/sadface"));
		}
		return image;
	}
}
